const overleyData = [
    [
        ...
        {
            idBg: 10,
            content: '<span>Первые гости уже прибыли — пришло время спеть что-нибудь на разогрев. Ты, как хозяин вечеринки, должен взять дело — то есть микрофон — в свои руки. Предлагаем начать с трека «Я волна» DJ Smash — хита 2008 года. А вот JBL PartyBox-On-The-Go никакие волны не страшны — благодаря корпусу, защищенному от влаги. И беспроводной микрофон к нему уже идет в комплекте!</span>',
            typeBtn: 'next',
            style: { height: '58.6em', width: '91.8em' }
        },
        {
            idBg: 11,
    ...
    [
        {
            idBg: 10,
            content: '<span>Песня о любви вызвала бурю эмоций. Окончательно распалить чувства гостей можно хитом, который цепляет даже крепких парней. Уверены: такую песню вы будете горланить все вместе. Кстати, знаете ли вы, что у JBL PartyBox On-The-Go есть переносной ремень, а на нем — открывалка для бутылок?</span>',
            typeBtn: 'next',
