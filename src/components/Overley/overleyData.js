const overleyData = [
    [
        ...
        {
            idBg: 10,
            content: '<span>Первые гости уже прибыли — пришло время спеть что-нибудь на разогрев. Ты, как хозяин вечеринки, должен взять дело — то есть микрофон — в свои руки! Предлагаем начать с трека «Я волна» DJ Smash — хита 2008 года. А вот JBL PartyBox-On-The-Go никакие волны не страшны — благодаря корпусу, защищенному от влаги.</span>',
            typeBtn: 'next',
            style: { height: '53.6em', width: '91.8em' }
        },
        {
            idBg: 11,
